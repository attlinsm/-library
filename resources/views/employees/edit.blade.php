    ...
    <div>
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <x-section-title>
                    <x-slot name="title">{{ __('Update your employee') }}</x-slot>
                    <x-slot name="description">{{ __('Form for update the employee, where you need to specify his email, password.') }}</x-slot>
                </x-section-title>
